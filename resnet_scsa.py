...
class Bottleneck(nn.Module):
  ...
  def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1):
    ...
    self.downsample = downsample
    self.stride = stride
    self.scsa = SCSA(planes * 4, head_num=1)
    #self.scsa = SCSA(planes * 4, head_num=1, window_size=-1)
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_dict = remove_fc(model_zoo.load_url(model_urls['resnet50']))
