...
# —— 在这里对齐 feature 行数 —— 
gallery_feature = gallery_feature[:len(gallery_label), :]
query_feature   = query_feature[:len(query_label), :]
print(result['gallery_label'].shape) 
...
ax.set_xlabel('Ours Distance')
ax.set_ylabel('Frequency')
ax.legend()


#fig.savefig('scatter.jpg', dpi=300, format='jpg')
